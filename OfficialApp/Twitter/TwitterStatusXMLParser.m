...
@implementation TwitterStatusXMLParser
...
- (void) parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName {
    ...
    } else if ([self.currentXpath isEqualToString: @"statuses/status/user/profile_image_url/"]) {
        [self.currentStatus setValue:textData forKey:@"image_url"];
    }
